...
contract SimplePaymentChannel {
    ...
    function close(uint256 amount, bytes memory signature) public {
        require(msg.sender == recipient, "msg.sender is not recipient");
        require(isValidSignature(amount, signature), "isValidSignature failed.");
    ...
    function extend(uint256 newExpiration) public {
        require(msg.sender == sender, "msg.sender is not sender");
